...
public class Menu {
	...
	public void greeting() {
		System.out.println("Р”Р°РЅРЅРѕРµ РїСЂРёР»РѕР¶РµРЅРёРµ РІ РєР°Р¶РґРѕРј СЃР»РѕРІРµ С‚РµРєСЃС‚Р° k-СЋ Р±СѓРєРІСѓ Р·Р°РјРµРЅСЏРµС‚ Р·Р°РґР°РЅРЅС‹Рј СЃРёРјРІРѕР»РѕРј.");
